...
public class NotificationPagerContainer extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public NotificationPagerContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }
 
    public NotificationPagerContainer(Context context, AttributeSet attrs, int defStyle) {
