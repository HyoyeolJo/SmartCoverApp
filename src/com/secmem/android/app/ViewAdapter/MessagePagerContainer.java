...
public class MessagePagerContainer extends FrameLayout implements ViewPager.OnPageChangeListener {
	 
    private ViewPager mPager;
    boolean mNeedsRedraw = false;
 
    public MessagePagerContainer(Context context) {
        super(context);
        init();
    }
 
    public MessagePagerContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
 
    public MessagePagerContainer(Context context, AttributeSet attrs, int defStyle) {
