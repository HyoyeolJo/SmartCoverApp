...
public class ArcLayout extends ViewGroup {
    ...
    private int mChildPadding = 160; //child ≥¢∏Æ ∞£∞› ¡π∏Æ¡‹
    ...
    public ArcLayout(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            Log.d(CommonInfo.TAG, "mFromDegrees: "+mFromDegrees+" mToDegrees: "+mToDegrees+"mChildSize :"+mChildSize);
    ...
    public void layout_setting(){
    	...
    	mChildSize = 400;
         ...
         final int _radius = mExpanded ? mRadius : 0;
         ...
         for (int i = 0; i < childCount; i++) {
             Rect frame = computeChildFrame(centerX, centerY, _radius, degrees, mChildSize);
             degrees += perDegrees;
    ...
    public void switchState(final boolean showAnimation) {
        if (showAnimation) {
            ...
            for (int i = 0; i < childCount; i++) {
                bindChildAnimation(getChildAt(i), i, 500);
            }
        }
    	Log.d(CommonInfo.TAG, "childCount : " + getChildCount());
